...
{
    [TestFixture]
    public class DeviceOwnerUserDevicesMigrationTests : MigrationTestBase
    {
        [Test]
        public async Task Migrate_DeviceOwnerUserDevices()
        {
            var service = new DeviceOwnerUserDevicesMigrationService();
