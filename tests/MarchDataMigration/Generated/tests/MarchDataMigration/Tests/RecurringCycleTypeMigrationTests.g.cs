...
{
    [TestFixture]
    public class RecurringCycleTypeMigrationTests : MigrationTestBase
    {
        [Test]
        public async Task Migrate_RecurringCycleType()
        {
            var service = new RecurringCycleTypeMigrationService();
