...
{
    [TestFixture]
    public class InvoiceLineItemsMigrationTests : MigrationTestBase
    {
        [Test]
        public async Task Migrate_InvoiceLineItems()
        {
            var service = new InvoiceLineItemsMigrationService();
