...
{
    [TestFixture]
    public class AccountTransactionCategoryMigrationTests : MigrationTestBase
    {
        [Test]
        public async Task Migrate_AccountTransactionCategory()
        {
            var service = new AccountTransactionCategoryMigrationService();
