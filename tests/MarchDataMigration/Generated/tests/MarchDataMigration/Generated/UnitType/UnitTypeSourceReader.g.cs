...
namespace MarchDataMigration.Generated.UnitType
{
    ...
    public static class UnitTypeSourceReader
    {
...
ORDER BY Id;";
        ...
        public static async Task<List<SourceUnitTypeRow>> LoadAsync(string connectionString, CancellationToken ct, int timeoutSeconds = 120)
        {
            ArgumentNullException.ThrowIfNull(connectionString);

            var rows = new List<SourceUnitTypeRow>();
            ...
            {
                rows.Add(new SourceUnitTypeRow
                {
