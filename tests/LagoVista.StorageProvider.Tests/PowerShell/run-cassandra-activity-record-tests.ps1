...
$evidenceDir = Join-Path $repoRoot ".coverage\evidence\cassandra-activity-record-store"
...
Write-Host "Running Cassandra activity record store integration tests against local Docker Cassandra..."
Write-Host "Evidence: $evidenceDir"

$startedUtc = [DateTime]::UtcNow.ToString("o")
@(
    "CloudStorage Cassandra Activity Record Store Integration Test Evidence"
    "StartedUtc: $startedUtc"
    "Project: $project"
    "Filter: TestCategory=CassandraActivityRecord"
