...
$evidenceDir = Join-Path $repoRoot ".coverage\evidence\application-data"
...
Write-Host "Running Application Data integration tests against local Docker Mongo..."
Write-Host "Evidence: $evidenceDir"

$startedUtc = [DateTime]::UtcNow.ToString("o")
@(
    "CloudStorage Application Data Integration Test Evidence"
    "StartedUtc: $startedUtc"
    "Project: $project"
    "Filter: TestCategory=ApplicationData"
