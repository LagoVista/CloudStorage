...
$evidenceDir = Join-Path $repoRoot ".coverage\evidence\mongo-infrastructure"
...
Write-Host "Running Mongo infrastructure integration tests against local Docker Mongo..."
Write-Host "Evidence: $evidenceDir"

$startedUtc = [DateTime]::UtcNow.ToString("o")
@(
    "CloudStorage Mongo Infrastructure Integration Test Evidence"
    "StartedUtc: $startedUtc"
    "Project: $project"
    "Filter: TestCategory=MongoInfrastructure"
