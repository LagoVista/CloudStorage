...
namespace Relational.Tests
{
    public sealed class SchemaValidator : SchemaContractTestBase {
        ...
        [Test]
        public async Task CheckSingleTable() => await AssertTableMatchesModelAsync(typeof(PaymentDeductionDTO), true, showEFSuggestions:true, showDBSuggestions:true, typesOnly:true );
