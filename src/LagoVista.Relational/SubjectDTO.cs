...
namespace LagoVista.Relational
{
    ...
    public class SubjectDTO
    {
        ...
        public static void Configure(ModelBuilder modelBuilder)
        {
            ...
            var entity = modelBuilder.Entity<SubjectDTO>();

            entity.HasKey(x => x.Id);
            entity.HasIndex(x => x.OwnerOrganizationId).HasDatabaseName("IX_Subjects_OwnerOrganizationId");
            entity.HasIndex(x => x.Key).IsUnique().HasDatabaseName("UX_Subjects_Key");
