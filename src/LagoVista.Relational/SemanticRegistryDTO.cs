...
namespace LagoVista.Relational
{
    ...
    public class SemanticRegistryDTO
    {
        ...
        public static void Configure(ModelBuilder modelBuilder)
        {
            ...
            entity.Property(x => x.Name).HasColumnOrder(2).HasColumnType(StandardDBTypes.NameStorage(provider));
            entity.Property(x => x.Revision).HasColumnOrder(3).HasColumnType(StandardDBTypes.LongStorage(provider));
            entity.Property(x => x.SeededFromRevision).HasColumnOrder(4).HasColumnType(StandardDBTypes.LongStorage(provider));
            entity.Property(x => x.SeededUtc).HasColumnOrder(5).HasColumnType(StandardDBTypes.UtcTimestampStorage(provider));
